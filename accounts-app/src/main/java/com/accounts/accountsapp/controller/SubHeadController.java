...
public class SubHeadController {
	...
	SubHeadService subheadService;
	 ...
	 @GetMapping("{id}")
	  public SubHeadResponse getSubheadDetails(@PathVariable Long id) {
	    return subheadService.test();
	  }
	  ...
	  public void updateSubheadt(@PathVariable Long id, @RequestBody SubHeadDTO subHeadDTO) {
	  ...
	  public void deleteSubhead(@PathVariable Long id) {
